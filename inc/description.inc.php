													...
													<ul>
														<li>
															<dl>
																...
																Данный файл включен во все остальные файлы проекта напрямую или чере DataBase</dd>
															</dl>
														</li>
														<li>
															<dl>
								...
								Ниже приведено описание собственных js-скриптов:<br>
									<ul>
										...
										<li>
											<dl>
												<dt>export.js</dt>
												<dd>Содержит функции, обеспечивающие создание текствого файла с расширением xls, содержащего список событий за выбранный пользователем временной период. Данный файл может быть открыт с помощью Microsoft Excel.</dd>
											</dl>
										</li>
										<li>
											<dl>
